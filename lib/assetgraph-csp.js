...
// FIXME: Would be good to adopt this asset here:
const ContentSecurityPolicy = require('assetgraph/lib/assets/ContentSecurityPolicy');
...
module.exports = function reviewContentSecurityPolicy(
  assetGraph,
